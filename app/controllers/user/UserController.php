...
class UserController extends BaseController {
    ...
    public function getIndex()
    {
        ...
        // Show the page
        return $this->view("site.user.index", compact('user'));
    }
    ...
    {
        return $this->view('site.user.create');
    }
    ...
    public function getLogin()
    {
        ...
        $this->prependTitle(Lang::get('site.login'));

        return $this->view('site.user.login', compact('csrfToken'));
    }
    ...
    {
        $this->prependTitle(Lang::get('user/user.forgot_password'));

        return $this->view('site.user.forgot');
    }
    ...
    public function getReset( $token )
    {
        ...
        return $this->view('site/user/reset')->with('token',$token);
    }
